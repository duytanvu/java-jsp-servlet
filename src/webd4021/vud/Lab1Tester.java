...
public class Lab1Tester {
  ...
  public static void main(String[] args)
    ...
    System.out.println(
        "\n*************************************************************************************************************");
    System.out.println(
        "NOTE: any exceptions displayed while instantiating Student objects in the program only display the contents "
    ...
    try {
      ...
      try {
        ...
        System.out.println(
            "\nTry to set the password for student1 to a String that is not valid (too short): "
                + newPassword
                + ".");
      ...
      try {
        String newPassword = "supercrazylongpasswordthatexceedsthemaximumlengthoffortycharacters";
        System.out.println(
            "\nTry to set the password to a String that is not valid (too long): "
                + newPassword
                + ".");
        student1.setPassword(newPassword);
      } catch (InvalidPasswordException ipe) {
    ...
    System.out.println(
        "\n*************************************************************************************************************");
    System.out.println(
        "NOTE: any exceptions displayed while instantiating Faculty objects will call the toString() method, "
    ...
    System.out.println(
        "\n\nTrying to instantiate my professor before displaying it, passing:\n\t"
            ...
            + possibleId
            + "\", \"another password\", \"Darren\", \"Puffer\", "
    ...
    try {
      ...
      System.out.println(
          "Problem creating a professor with an id of: \""
              + possibleId
              + "\"\n\t "
              + ide.toString());
    }
